...
namespace FirstDemoApp {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string EmployeeName, string Salary, string Department, int CustomerId) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public int CustomerId {
                get {
                    try {
                        return ((int)(this[this.tableEmployees.CustomerIdColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace FirstDemoApp.DataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([EmployeeName], [Salary], [Department], [CustomerI" +
                "d]) VALUES (@EmployeeName, @Salary, @Department, @CustomerId)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [EmployeeName] = @EmployeeName, [Salary] = @Salary, " +
                "[Department] = @Department, [CustomerId] = @CustomerId WHERE (([EmployeeId] = @O" +
                "riginal_EmployeeId))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CustomerDBConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeId, EmployeeName, Salary, Department, CustomerId FROM dbo.Employee" +
                "s";
        ...
        public virtual int Insert(string EmployeeName, string Salary, string Department, global::System.Nullable<int> CustomerId) {
        ...
        public virtual int Update(string EmployeeName, string Salary, string Department, global::System.Nullable<int> CustomerId, int Original_EmployeeId) {
            if ((EmployeeName == null)) {
